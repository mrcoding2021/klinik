        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 mb-3 d-flex justify-content-center">
                    <p class="alert alert-warning mr-3"><i class="fas fa-home"></i> Apakah Anda bersedia melakukan Rapid Test Covid19 secara mandiri ? </p>
                    <p><a href="#" class="yes btn btn-lg bg-success text-white">Ya, Tentu Saja !</a></p>
                </div>
                <div class="col-md-12 mb-3" id="form">
