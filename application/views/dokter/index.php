             ...
             <div class="col-lg">
                 ...
                 <div class="card">
                     <div class="card-header">
                         <a href="<?= base_url('dokter/detail')?>" class=" btn btn-primary" >Tambah Menu</a>
                     </div>
                     <!-- /.card-header -->
                     <div class="card-body">
                         <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                             ...
                             <div class="row">
                                 <div class="col-sm-12">
                                     <table id="dokter" class="table table-sm table-bordered table-striped dataTable dtr-inline" width="100%">
                                         <thead>
                                             <tr role="row">
                                                 <th>No</th>
                                                 <th>Foto</th>
