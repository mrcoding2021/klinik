                                     ...
                                     <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                         <thead>
                                             <tr role="row">
                                                 ...
                                                 <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Nama Menu</th>
                                                ...
                                                foreach ($menu as $key) : ?>
                                                 <tr role="row" class="odd">
                                                     ...
                                                     <td><?php if ($key['is_active'] == 1) : ?>
                                                         ...
                                                         <?php endif ?></td>
                                                     <td>
                                                         <a href="<?= base_url('menu/edit/'). $key['id_menu'] ?>" class="btn btn-primary btn-sm" >Edit
                                                         </a>
                                                         <a href="<?= base_url('menu/delete/') . $key['id_menu'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin akkan menghapus data ini ?')">Delete
                                                         </a>
                                                     </td>
                                                 </tr>
                                             <?php endforeach ?>
